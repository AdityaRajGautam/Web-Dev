...
//     .then((response) => {
//       if (!response.ok) {
//         throw new Error(`Problem with Geocoder ${response.status}`);
//       }
//       return response.json();
//     })
//     .then((data) => {
...
// Promise.resolve("aditya").then((x) => console.log(x));
...
//     // country data
//     // this is same as async-await
//     // fetch(
//     //   `https://restcountries.com/v2/name/${country}`.then((res) =>
//     //     console.log(res)
//     //   )
//     // );
...
//     return ` Your are ${data.city},${data.country}`;
//   } catch (err) {
//     console.log(`${err}🔥`);
...
//   .finally(() => {
//     console.log("3: Finished getting locaton");
//   });
...
// all promises are running one by one
...
//     // all promises are running at the same time
...
//   }
// };
// get3Countries("bharat", "australia", "turkey");
...
// // Promise.AllSetteled(it gives result for all the responses wether fullfilled or not)
// Promise.allSettled([
...
// // Promise.any(it returns the firs fullfilled promise)
// Promise.any([
//   Promise.reject("Error"),
//   Promise.resolve("2success"),
//   Promise.resolve("success"),
// ]).then((res) => console.log(res));
...
GOOD LUCK 😀
*/
////////////Refrence from codinng challange 2
// const wait = function (seconds) {
//   return new Promise(function (resolve) {
//     setTimeout(resolve, seconds * 1000);
//   });
