...
const account1 = {
  ...
  movementsDates: [
    ...
    "2023-02-24T23:36:17.929Z",
    "2023-02-27T10:51:36.790Z",
  ],
  currency: "EUR",
  locale: "pt-PT", // de-DE
};
...
// // SET TIMEOUT
// const ingredients = ["paneer", "capsicum"];
...
// if (ingredients.includes("capsicum")) {
...
//     second: "numeric",
//   };
//   const clock = new Intl.DateTimeFormat("en-IN", options).format(now);
